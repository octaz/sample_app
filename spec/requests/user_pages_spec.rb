  ...
  describe "signup page" do
    ...
    describe "index page" do
      before do
        ...
        FactoryGirl.create(:user, name: "tina", email: "tina@exmaple.com")
        visit users_path
      end
      ...
      # it "should list each user" do ## old code
    ...
    describe "profile page" do
      ...
      describe "should display the microposts and total count" do
      ...
      describe "follow/unfollow buttons" do
        ...
        describe "following a user" do
          ...
          it "should increment hte followed user count" do
            expect do
              click_button "Follow"
        ...
        describe "unfollowing a user" do
          ...
          it "should lower the followed user count" do
            expect do
              click_button "Unfollow"
            end.to change(user.followed_users, :count).by(-1)
          end

          it "should lower the other user followers count" do
            expect do
              click_button "Unfollow"
            end.to change(other_user.followers, :count).by(-1)
          end
